...
<center>
 ...
 <script type="text/javascript" src="js/fileselection.js"></script>
  ...
  <form name="add_staff" class="registartion-form" action="add_doctor" method="post">
      <table> 
         <h1 style='color:black;'>ADD DOCTOR</h1>
         <% String name2 = (String) request.getParameter("name"); %>
      <tr>
        <td><label for="hospital">Doctor Name:</label></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="doctorname" id="staffname" placeholder="John" required="required"></td>
      </tr>
      <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="sp" id="sp" placeholder="Ex: Cardiologist" required="required"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2"><input type="submit" class="submit" value="Add Doctor" /></td>
      </tr>
      <tr>
 ...
 <footer class="main-footer">
  ...
  <%
   ...
   String sAction = (String) request.getAttribute("alertMsg"); %> 
    ...
    <% if(aSuccess=="Doctor Details Added Successfully"){ %>
    <script>
