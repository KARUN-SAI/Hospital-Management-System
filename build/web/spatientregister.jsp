...
<center>
 ...
 <script type="text/javascript" src="js/fileselection.js"></script>
  ...
  <form name="add_staff" class="registartion-form" action="add_worker" method="post">
      <table> 
         <h1 style='color:black;'>ADD WORKER</h1>
     ...
     <tr>
      ...
      <tr>
          <tr>
        <td><label for="hospital">Position</label></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="position" id="staffname"required="required"></td>
      </tr>
      <tr>
 ...
 <footer class="main-footer">
  ...
  <%
   ...
   String sAction = (String) request.getAttribute("alertMsg"); %> 
    ...
    <% if(aSuccess=="Patient Details Added Successfully"){ %>
    <script>
