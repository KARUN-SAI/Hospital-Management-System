 ...
 /*   if(name2.isEmpty()){
   ...
   <div class="container1" style="width:100%;height:100%;position:absolute;">
                   ...
                   <table border="1" style="height:50px;width: 1000px;">
                       <br>
                        <h1 style='color:black;'>WORKER'S LIST</h1>
                        <br>
                        <tr>
                      ...
                      System.out.println("Getconnection Start");
                       stmt = con.createStatement();
                        stmt1 = con.createStatement();
                         String sql="select * from worker_details";
...
<!--                     <td style="height: 50px;width:70px;"> <% out.println(rs.getString(1)); %> </td>-->
                     <td><% out.println(rs.getString(2)); %></td>
                        ...
                        <td>
                        <button id="delete" style="background-color:blue;" value="<%  out.println(rs.getString(1)); %>" onclick="location.href='http://localhost:8080/Hospital_network/deleteworker?name=<%=name2%>&id=<%=id%>';">Delete</button></td>
 ...
 String aSuccess1=  (String) request.getAttribute("alertMsg"); %> 
    ...
    <script>
        alert("Worker Details Deleted Successfully");
