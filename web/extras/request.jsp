...
<body>
   ...
   <div class="container1" style="width:100%;height:100%;position:absolute;">
                   ...
                   <table border="1" style="height:50px;width: 1000px;">
                       <br>
                        <h1 style='color:black;'>Appointment details</h1>
                        <br>
                        <tr>
...
{ int id=rs.getInt(1);%>
                     ...
                     <td style="height: 50px;width:70px;"> <% out.println(rs.getString(2)); %> </td>
                        ...
                        <td><%  out.println(rs.getString(14)); %></td>
                         ...
                         <td style="height:auto;width:auto;"> <button id="accept" style="background-color:green;" value="<%  out.println(rs.getString(9)); %>" onclick="location.href='http://localhost:8080/Hospital_network/acceptpayment?name=<%=name%>&id=<%=id%>';">Accept</button>
                             <button id="delete" style="background-color:red;" value="<%  out.println(rs.getString(9)); %>" onclick="location.href='http://localhost:8080/Hospital_network/deletepayment?name=<%=name%>&id=<%=id%>';">Remove</button></td>
