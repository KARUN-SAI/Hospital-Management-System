...
alert(coffee_id);
window.open("http://localhost:8080/Hospital_network/editstaff.jsp?id="+coffee_id);
...
function deletecoffee(){
 ...
 var doIt=confirm('Do you want to delete the record?');
  if(doIt){
   ...
   window.open("http://localhost:8080/Hospital_network/deletestaff?id="+coffee_id);
    }
  else{
                   ...
                   <table border="1" style="height:50px;width: 1000px;">
                    ...
                    System.out.println("list:"+name2);
                     ...
                     <td><% out.println(rs.getString(3)); %></td>
                        ...
                        <td><button id="edit" value="<%  out.println(rs.getString(6)); %>" onclick="location.href='http://localhost:8080/Hospital_network/editstaff.jsp?name=<%=name2%>&id=<%=id%>';">Edit</button>
                        <button id="delete" value="<%  out.println(rs.getString(6)); %>" onclick="location.href='http://localhost:8080/Hospital_network/deletestaff?name=<%=name2%>&id=<%=id%>';">Delete</button></td>
